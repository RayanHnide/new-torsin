...
import { IoChevronDown ,IoChevronUp,IoEyeOutline } from "react-icons/io5";
...
export default function ChangePassword({ styles }) {
    ...
    const handleSubmit = () => {
        setShowErrors(true);
        if (
            !Validation.minOfNew(oldPassword, 8) ||
            ...
            <Modal centered show={successModal} onHide={() => setSuccessModal(false)} backdrop="static">
                ...
                <Modal.Body>
                    <div className='text-center px-5 py-3'>
                        <p className={`${styles.deleteJobTitle}`}>Password changed successfully</p>
                        <p className={`${styles.deleteJobDesc} px-4`}>Now you can stay logged in or log off from current active session</p>
                        <div>
                            ...
                            <Form>
                                <Form.Group className='position-relative my-3'>
                                    <Form.Control
                                        ...
                                        isInvalid={showErrors && !Validation.minOfNew(oldPassword, 8)}
                                        ...
                                        eyeIcon1 && (
                                            !showErrors ?
                                                ...
                                                <IoEyeOutline
                                                    size={20}
                                                    color='grey'
                                                    className={`cursor-pointer ${!Validation.minOfNew(oldPassword, 8) ? styles.resetEye1 : styles.resetEye}`}
                                                    onClick={() => setShowPassword(true)}
                                                />
                                        ...
                                        eyeIcon2 && (
                                            !showErrors ?
                                                ...
                                                <IoEyeOutline
                                                    size={20}
                                                    color='grey'
                                                    className={`cursor-pointer ${!Validation.minOfNew(newPassword, 8) ? styles.resetEye1 : styles.resetEye}`}
                                                    onClick={() => setShowPassword2(true)}
                                                />
                                        )
                                        :
                                        ...
                                        eyeIcon3 && (
                                            !showErrors ?
                                                ...
                                                <IoEyeOutline
                                                    size={20}
                                                    color='grey'
                                                    className={`cursor-pointer ${(confirmPassword !== newPassword || !Validation.minOfNew(confirmPassword, 8)) ? styles.resetEye1 : styles.resetEye}`}
                                                    onClick={() => setShowPassword3(true)}
                                                />
                                        )
                                        :
